...
const upcomingMeetings =
  dashboardData && dashboardData.meetings
    ? dashboardData.meetings.filter((meeting) => {
        ...
        // // Log the dates and comparison result
        // console.log('Meeting Date:', meetingDateObject);
        // console.log('Current Date:', currentDateObject);
        // console.log(
        //   "Is meeting date >= current date?",
        //   meetingDateObject >= currentDateObject
        // );
    ...
    <div className="flex flex-col md:flex-row h-screen">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="p-6 mt-4">
          ...
          <div className="flex flex-col gap-3 items-center w-11/12 m-auto mt-12 bg-gray-100 rounded-xl p-4 shadow-md shadow-gray-200">
